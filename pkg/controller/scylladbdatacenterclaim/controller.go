...
//func (sccc *Controller) enqueueOwnerOrAllWithMatchingTierLabel(depth int, obj kubeinterfaces.ObjectInterface, operation socontrollerhelpers.HandlerOperationType) {
//	scc := sccc.resolveScyllaDBDatacenterClaimController(obj)
//	if scc != nil {
//		sccc.handlers.Enqueue(depth+1, scc, operation)
//		return
//	}
//
//	scyllaDBClusterTierName, ok := obj.GetLabels()[naming.ScyllaDBClusterTierLabel]
//	if !ok {
//		return
//	}
//
//	isScyllaDBClusterClaimWithTier := func(scc *pausingv1alpha1.ScyllaDBDatacenterClaim) bool {
//		return scc.Spec.ScyllaDBClusterTierName == scyllaDBClusterTierName
//	}
//
//	sccc.handlers.EnqueueAllFunc(sccc.handlers.EnqueueWithFilterFunc(isScyllaDBClusterClaimWithTier))(depth+1, obj, operation)
//}
//
//func (sccc *Controller) resolveScyllaDBDatacenterClaimController(obj metav1.Object) *pausingv1alpha1.ScyllaDBDatacenterClaim {
...
//	}
//
//	sdc, err := sccc.scyllaDBDatacenterClaimLister.ScyllaDBDatacenterClaims(obj.GetNamespace()).Get(controllerRef.Name)
//	if err != nil {
//		return nil
//	}
//
