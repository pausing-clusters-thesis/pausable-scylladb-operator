...
import (
	...
	pausing "github.com/pausing-clusters-thesis/pausable-scylladb-operator/pkg/client/pausing/informers/externalversions/pausing"
...
type SharedInformerFactory interface {
	...
	Pausing() pausing.Interface
}

func (f *sharedInformerFactory) Pausing() pausing.Interface {
	return pausing.New(f, f.namespace, f.tweakListOptions)
}
