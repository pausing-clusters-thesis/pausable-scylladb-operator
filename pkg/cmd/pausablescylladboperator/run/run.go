...
func NewCommand(streams genericiooptions.IOStreams) *cobra.Command {
	...
	// TODO: comment
	cmd.Flags().StringVarP(&o.ProxyStorageClassName, "proxy-storageclass-name", "", o.ProxyStorageClassName, "")
...
func (o *Options) Validate() error {
	...
	if len(o.ProxyStorageClassName) == 0 {
		errs = append(errs, fmt.Errorf("proxy-storageclass-name can't be empty"))
	}
